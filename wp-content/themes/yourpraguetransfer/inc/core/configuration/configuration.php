...
define("BASE_CURRENCY","CZK");
if(isset($_SESSION['prefered_currency'])){
    define("CURRENCY_CODE", $_SESSION['prefered_currency']);
    foreach ($currencies as $key => $val){
        if($val['code'] == $_SESSION['prefered_currency']){
            define("CURRENCY", $val['label']);
        }
    }
}else{
    define("CURRENCY", "Kč");

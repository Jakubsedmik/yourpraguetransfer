    ...
    <div class="s7_underpage-slider-sw s7_sw-sec mx-auto">
        ...
        <div class="s7_underpage-col-row mx-auto d-flex justify-content-center">
            <div class="s7_underpage-ico d-flex align-items-center">
                <figure class="mb-0"><img src="<?php echo FRONTEND_IMAGES_PATH ?>/route.png" alt="" class="w-100"></figure>
                <p class="s7_underpage-text font-weight-light text-white mb-0"><strong class="text-white">14.3</strong> Km</p>
            </div>
            <div class="s7_underpage-ico d-flex align-items-center">
                <figure class="mb-0"><img src="<?php echo FRONTEND_IMAGES_PATH; ?>/time.png" alt="" class="w-100"></figure>
                <p class="s7_underpage-text font-weight-light text-white mb-0"><strong class="text-white">28</strong> min</p>
            </div>
            <div class="s7_underpage-ico d-flex align-items-center">
                <figure class="mb-0"><img src="<?php echo FRONTEND_IMAGES_PATH; ?>/money.png" alt="" class="w-100"></figure>
    ...
    <div class="s7_car-col col-xl-6 col-12 pr-0">
        ...
        <div class="s7_nabidka-aut">
            <div class="s7_nabidka-aut-info d-flex">
                <figure class="s7_res-car-img mb-0 position-relative"><img src="<?php echo FRONTEND_IMAGES_PATH; ?>/auto-reservation.png" alt=""></figure>
            ...
            <div class="s7_nabidka-aut-sluzby d-flex flex-row">
                <div class="s7_reservation-ico text-center d-flex align-items-center">
                    <figure class="s7_res-ico mb-0"><img src="<?php echo FRONTEND_IMAGES_PATH; ?>/res-ico-4.png" alt="láhev vody" class="s7_reservation-ico-img"></figure>
                    <p class="s7_reservation-ico-text text-uppercase font-weight-bold mb-0">Pití zdarma</p>
                </div>
                <div class="s7_reservation-ico text-center d-flex align-items-center">
                    <figure class="s7_res-ico mb-0"><img src="<?php echo FRONTEND_IMAGES_PATH; ?>/res-ico-1.png" alt="platební karty" class="s7_reservation-ico-img"></figure>
                    <p class="s7_reservation-ico-text text-uppercase font-weight-bold mb-0">Platba online</p>
                </div>
                <div class="s7_reservation-ico text-center d-flex align-items-center">
                    <figure class="s7_res-ico mb-0"><img src="<?php echo FRONTEND_IMAGES_PATH; ?>/res-ico-3.png" alt="štít" class="s7_reservation-ico-img"></figure>
                    <p class="s7_reservation-ico-text text-uppercase font-weight-bold mb-0">Bezpečnost</p>
                </div>
                <div class="s7_reservation-ico text-center d-flex align-items-center">
                    <figure class="s7_res-ico mb-0"><img src="<?php echo FRONTEND_IMAGES_PATH; ?>/res-ico-2.png" alt="wifi" class="s7_reservation-ico-img"></figure>
                    <p class="s7_reservation-ico-text text-uppercase font-weight-bold mb-0">Wifi na palubě</p>
                </div>
                <div class="s7_reservation-ico text-center d-flex align-items-center">
                    <figure class="s7_res-ico mb-0"><img src="<?php echo FRONTEND_IMAGES_PATH; ?>/res-ico-4.png" alt="nonstop" class="s7_reservation-ico-img"></figure>
                    <p class="s7_reservation-ico-text text-uppercase font-weight-bold mb-0">Pití zdarma</p>
                </div>
                <div class="s7_reservation-ico text-center d-flex align-items-center">
                    <figure class="s7_res-ico mb-0"><img src="<?php echo FRONTEND_IMAGES_PATH; ?>/res-ico-1.png" alt="platební karty" class="s7_reservation-ico-img"></figure>
...
<section id="res-contact" class="container-fluid d-flex justify-content-center">
    <div class="s7_res-contact-phone d-flex align-items-center">
        <figure class="mb-0"><img src="<?php echo FRONTEND_IMAGES_PATH; ?>/phone.png" alt="phone" class="s7_res-contact-ico-img w-100"></figure>
    ...
    <div class="s7_res-contact-envelope d-flex align-items-center">
        <figure class="mb-0"><img src="<?php echo FRONTEND_IMAGES_PATH; ?>/envelope.png" alt="phone" class="s7_res-contact-ico-img w-100"></figure>
    ...
    <div class="s7_res-contact-map d-flex align-items-center">
        <figure class="mb-0"><img src="<?php echo FRONTEND_IMAGES_PATH; ?>/map-mark.png" alt="phone" class="s7_res-contact-ico-img w-100"></figure>

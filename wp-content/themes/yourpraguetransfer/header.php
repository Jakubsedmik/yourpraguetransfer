...
<html lang="en">
    <head>
        ...
        <!-- Justified Gallery -->
        <link rel="stylesheet" href="<?php echo home_url(); ?>/wp-content/themes/yourpraguetransfer/assets/JustifiedGallery/justifiedGallery.min.css">
        <script src="<?php echo home_url(); ?>/wp-content/themes/yourpraguetransfer/assets/JustifiedGallery/jquery.justifiedGallery.min.js"></script>

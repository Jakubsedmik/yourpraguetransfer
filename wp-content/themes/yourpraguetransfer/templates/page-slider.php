    ...
    <div class="s7_main-slider-sw s7_sw-sec mx-auto">
        ...
        <div class="row s7_slider-usps animate__animated animate__fadeInUp animate__delay-5s">
            <div class="s7_slider-ico col text-center">
                ...
                <p class="s7_slider-ico-text text-uppercase font-weight-bold"><?php echo get_theme_mod( "usp1" ); ?></p>
            </div>
            <div class="s7_slider-ico col text-center">
                ...
                <p class="s7_slider-ico-text text-uppercase font-weight-bold"><?php echo get_theme_mod( "usp2" ); ?></p>
            </div>
            <div class="s7_slider-ico col text-center">
                ...
                <p class="s7_slider-ico-text text-uppercase font-weight-bold"><?php echo get_theme_mod( "usp3" ); ?></p>
            </div>
            <div class="s7_slider-ico col text-center">
                ...
                <p class="s7_slider-ico-text text-uppercase font-weight-bold"><?php echo get_theme_mod( "usp4" ); ?></p>
            </div>
            <div class="s7_slider-ico col text-center">
                ...
                <p class="s7_slider-ico-text text-uppercase font-weight-bold"><?php echo get_theme_mod( "usp5" ); ?></p>
            </div>
        </div>
        <div class="text-center animate__animated animate__fadeInUp animate__delay-5s">
            <a href="<?php echo get_theme_mod( "slider_covid_url" ); ?>" class="s7_slider-covid d-flex mx-auto w-100 align-items-center justify-content-center"><img src="<?php echo FRONTEND_IMAGES_PATH; ?>/virus.png" alt="virus" class="s7_virus-img w-100 mr-2"><span class="s7_slider-covid-text text-white text-uppercase"><?php echo get_theme_mod( "slider_covid_text" ); ?></span></a>
        </div>
    </div>
</section>